import style from "./TransformationPhases.module.scss";
import stepOneImg from "../Images/business.png";
import stepTwoImg from "../Images/chatBot.png";
import stepThreeImg from "../Images/low_code.png";
// import stepFourImg from "../Images/documents.png";
import stepFourImg from "../Images/documents2.png";
import stepFiveImg from "../Images/analysis.png";
...
function TransformationSteps({ isPageMounted }) {
  ...
  useLayoutEffect(() => {
    ...
    const arr = gsap.utils.toArray(`.${style.step}`);
    // arr.forEach((step) => {
    //   gsap.to(step, {
    //     scrollTrigger: {
    //       id: "trigger1",
    ...
    <>
      <div className={style.transformationStepsWrapper}>
        <div className={style.sectionTitle}>
          <h1>Our digital transfomration journy</h1>
          <p>
            The typical five phases our clients go through when we help them
            transform their business process using technology.
          </p>
        </div>
              ...
              <div className={style.stepsText}>
                <div className={style.step} data-index={0}>
                  ...
                  <div className={style.stepText}>
                    ...
                    <p className={style.stepDescription}>
                      Digital tools support traditional operations. Legacy
                      systems
                    </p>
                  </div>
                </div>
                <div className={style.step} data-index={1}>
                  ...
                  <div className={style.stepText}>
                    ...
                    <p className={style.stepDescription}>
                      ...
                      interfaces. Applications are isolated, and its services
                      may be redundant.
                    </p>
                  </div>
                </div>
                ...
                <div className={style.step} data-index={3}>
                  ...
                  <div className={style.stepText}>
                    ...
                    <p className={style.stepDescription}>
                      All applications are built on modern, and unified
                      platform, CI/CD pipeline and DevOps practices applied
                    </p>
                  </div>
                </div>
